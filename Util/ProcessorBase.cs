...
namespace KlaviyoDotNet.Util
{
    public abstract class ProcessorBase
    {
        ...
        /// <summary>
        /// constant for "application/x-www-form-urlencoded" content type
        /// </summary>
        public const string X_WWW_FORM_URLENCODED_CONTENT_TYPE = "application/x-www-form-urlencoded";
    ...
    public class FormDataContentType : IContentType
    {
        ...
        {
            this.Value = ProcessorBase.X_WWW_FORM_URLENCODED_CONTENT_TYPE;
        }
