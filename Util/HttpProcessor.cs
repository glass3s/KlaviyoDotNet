...
namespace KlaviyoDotNet.Util
{
    public class HttpProcessor : ProcessorBase
    {
        ...
        public RawApiResponse HttpRequest(string url, HttpMethod method, IContentType contentType, string apiKey, string data)
        {
            byte[] bytes = null;
            ...
            return HttpRequest(url, method, contentType, apiKey, bytes);
        }
        ...
        /// <param name="data">Data if any</param>
        /// <returns>RawApiResponse</returns>
        public RawApiResponse HttpRequest(string url, HttpMethod method, IContentType contentType, string apiKey, byte[] data, Dictionary<string, string> formData = null)
        {
            var address = url;
